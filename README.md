...
Create Style component import `styled` and put `.` and then add your **_html tag_** do the styles there. One thing to remember that as it'll return a component then we need to store in variable with Uppercase. Not only the tag name we can write any name there for use.
...
**_ Note: _** Here it'll generate the class css with unique value.
...
**_ Note:_** in JSX format we can write in styled component
...
**1st we need to add the toaster in component tree**
